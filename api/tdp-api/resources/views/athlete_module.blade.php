...
<body>
    ...
    <div class="intestazione col-12 text-bold mb-3">
        <div class="intestazione-immagine">
            <img src="{{ public_path('/images/teste-di-pietra-logo.png') }}" style="width: 100px; height: 100px">
        </div>
    ...
    <div class="col-12 mb-3">
        <div class="col-6 text-bold" style="font-size:1.1rem;">
            Il/La sottoscritto/a:
        </div>
        <div class="col-6" style="font-style: italic; font-size:1.1rem;text-align:right;">
...
posta comune o e-mail.
    ...
    <div class="col-12 mb-4">
        <div class="col-6 text-center">
            <div class="consent-box"></div>&nbsp;presto il consenso
        </div>
        <div class="col-6 text-center">
